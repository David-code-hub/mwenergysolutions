<template>
  <header class="absolute inset-x-0 top-0 z-50">
    <nav
      class="mx-auto flex max-w-7xl items-center justify-between py-6 lg:px-0 px-5"
      aria-label="Global"
    >
      <div class="flex lg:flex-1">
        <a href="#" class="-m-1.5 p-1.5">
          <span class="sr-only">Mwenergysolutions</span>
          <img
            class="lg:h-35 h-20 w-auto"
      ...
      <div class="hidden lg:flex lg:flex-1 lg:justify-end">
        <div class="hidden lg:flex lg:gap-x-12 my-auto mr-7">
          <a
      ...
      >
        ...
        <a
          href="#contactUs"
          @click="openMenu = false"
          class="text-md font-normal leading-6 text-white bg-[#0E46A3] rounded-full py-2 px-5"
          >Contact Us</a
        >
      </div>
    </nav>
